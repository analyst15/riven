  ...
  return (
    <>
      <div className="flex items-center justify-center">
        <h1 className="text-4xl md:text-base font-bold lg:text-base text-center text-black my-8 lg:mt-16">Our Products</h1>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 lg:p-4">
        <div className="lg:p-4">
          ...
          <p className="text-base pb-10 lg:pb-24">Discover the best global and local stocks to invest in. Get unrestricted access to the U.S. and Nigerian stock markets, right from your mobile phone or computer.</p>
